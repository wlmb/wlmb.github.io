...
Notice that I got the same solution, though visiting the cities in
the opposite order. I plot below the evolution of the simulation.
...
good solutions to the traveling salesman which, though may not be
truly optimal, they may be good enough for many
applications. However, the true optimum obtained from an exhaustive
search would be prohibitively expensive even
