...
*n=(s+1)/6*.
    ...
    17              my $q=$k*(3*$k-1)/2;
    18              say("p$j=$p, p$k=$q, p$j+p$k=", $p+$q, "=p", index_of($p+$q),
    19                    " p$j-p$k=", $p-$q, "=p", index_of($p-$q)),
...
Results:
    ...
    p2167=7042750, p1020=1560090, p2167+p1020=8602840=p2395 p2167-p1020=5482660=p1912
    Time: 330.049680948257
