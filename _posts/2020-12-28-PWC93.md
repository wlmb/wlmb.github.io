...
or equivalently, if (x1-x0)\*(yn-x0)==(y1-y0)\*(xn-x0).
...
ths sum of all its subtrees plus the node times the number of
subtrees.
...
subtree, each of which ought to be represented by a perl array. It
