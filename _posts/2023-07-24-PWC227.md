...
First I know how many previous leap years there have been since, say, year 0,
...
are not leap years, unless the are multiples of 400 which are leap
...
weekday 1 and the first day of the month is 1. Therefore, the result
is obtained by counting how many months start in the weekday 1.
...
references without repeating code. I used the cpan module `Text::Roman` to
...
strings of the form "operand operator operand".

For the full code I avoided for fun the canned solution and made my own
translation to and from roman.
I use `try/catch` to
