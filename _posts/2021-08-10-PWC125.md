...
and *y=2ab*. Notice that
*x<sup>2</sup>+y<sup>2</sup>=(a<sup>2</sup>-b<sup>2</sup>)<sup>2</sup>+4a<sup>2</sup>b<sup>2</sup>=(a<sup>2</sup>+b<sup>2</sup>)<sup>2</sup>* so that *(x, y,
z)* with *z=a<sup>2</sup>+b<sup>2</sup>* form a Pythagorean triplet. It turns out
...
diameter (it may be a self-reference).
